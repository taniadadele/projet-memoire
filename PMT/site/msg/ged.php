...
static	$USER_MY_FILES             = 207;
static	$USER_ADDFOLDER            = 208;
static	$USER_RENAME               = 209;
static	$USER_CURRENT_FILE_NAME    = 210;
static	$USER_SHOW_IN_PARENT       = 211;
static	$USER_RESEARCH             = 212;
static	$USER_MY_FILES_LIGHT       = 213;
static	$USER_SHARED_FILES         = 214;
static  $USER_MOVE_ELEMENT         = 215;
static  $USER_SHARE                = 216;
static  $USER_FILES_OF_THE_USER    = 217;
static  $USER_COPIES               = 218;
static  $USER_SHARE_MAIL           = 219;
static  $USER_SHARE_LINK           = 220;
